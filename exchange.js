...
async function addLiquidity(amountEth, maxSlippagePct) {
		var poolState = await getPoolState();
		max_exchange_rate = (100*(1 + (maxSlippagePct/100))) * poolState['eth_token_rate'];
		min_exchange_rate = (100*(1 - (maxSlippagePct/100))) * poolState['eth_token_rate'];
		await token_contract.methods.approve(exchange_address, 100000000000).send({from:web3.eth.defaultAccount.toLowerCase(), gas:1000000});
  	await exchange_contract.methods.addLiquidity(max_exchange_rate, min_exchange_rate).send({from:web3.eth.defaultAccount.toLowerCase(), value:amountEth, gas:1000000});
}
...
async function removeLiquidity(amountEth, maxSlippagePct) {
		...
		max_exchange_rate = (100*(1 + (maxSlippagePct/100))) * poolState['eth_token_rate'];
		min_exchange_rate = (100*(1 - (maxSlippagePct/100))) * poolState['eth_token_rate'];
		await exchange_contract.methods.removeLiquidity(amountEth, parseInt(max_exchange_rate), parseInt(min_exchange_rate)).send({from:web3.eth.defaultAccount.toLowerCase(), gas:1000000});
}
...
async function removeAllLiquidity(maxSlippagePct) {
		...
		max_exchange_rate = (100*(1 + (maxSlippagePct/100))) * poolState['eth_token_rate'];
		min_exchange_rate = (100*(1 - (maxSlippagePct/100))) * poolState['eth_token_rate'];
		await exchange_contract.methods.removeAllLiquidity(parseInt(max_exchange_rate), parseInt(min_exchange_rate)).send({from:web3.eth.defaultAccount.toLowerCase(), gas:1000000});
}
...
async function swapTokensForETH(amountToken, maxSlippagePct) {
		var poolState = await getPoolState();
		max_exchange_rate = (100*(1 + (maxSlippagePct/100))) * poolState['eth_token_rate'];
		await token_contract.methods.approve(exchange_address, amountToken).send({from:web3.eth.defaultAccount.toLowerCase(), gas:1000000});
    await exchange_contract.methods.swapTokensForETH(amountToken, parseInt(max_exchange_rate)).send({from:web3.eth.defaultAccount.toLowerCase(), gas:1000000});
}

async function swapETHForTokens(amountETH, maxSlippagePct) {
	  var poolState = await getPoolState();
	  max_exchange_rate = (100*(1 + (maxSlippagePct/100))) * poolState['token_eth_rate'];
		console.log(max_exchange_rate);
    await exchange_contract.methods.swapETHForTokens(parseInt(max_exchange_rate)).send({from:web3.eth.defaultAccount.toLowerCase(), value:amountETH, gas:1000000});
		//await exchange_contract.methods.swapETHForTokens(100).send({from:web3.eth.defaultAccount.toLowerCase(), value:amountETH, gas:1000000})
}
